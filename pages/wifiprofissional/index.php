...
<section class="wifi-pro-page">
    <div class="wifi-pro-page__hero"<?= !empty($_bn['imagem']) ? ' style="--hero-image:url(\'' . BASE_URL . '/images/banners/wifiprofissional/' . htmlspecialchars($_bn['imagem']) . '\')"' : '' ?>>
        <div class="container">
            ...
            <div class="container">
                <div class="wifi-pro-page__cta-box">
                    ...
                    <div class="wifi-pro-page__cta-actions">
                        <a class="wifi-pro-page__cta-button wifi-pro-page__cta-button--whatsapp" href="https://wa.me/5508002225262" target="_blank" rel="noopener"><i class="icon-whatsapp" aria-hidden="true"></i><span>Falar no WhatsApp <strong>0800 222 5262</strong></span></a>
