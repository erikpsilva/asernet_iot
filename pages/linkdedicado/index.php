    ...
    <div class="link-dedicado-page__hero">
        <div class="container">
            <div class="link-dedicado-page__hero-copy">
                <h1>Link dedicado <strong>para empresas que n&atilde;o podem parar.</strong></h1>
                <p>Conex&atilde;o exclusiva, est&aacute;vel e com alta performance para manter sua opera&ccedil;&atilde;o sempre conectada.</p>

                <ul>
                    <li><i class="icon-checkmark" aria-hidden="true"></i>Banda exclusiva</li>
                    <li><i class="icon-checkmark" aria-hidden="true"></i>Baixa lat&ecirc;ncia</li>
                    <li><i class="icon-checkmark" aria-hidden="true"></i>Alta estabilidade</li>
                    <li><i class="icon-checkmark" aria-hidden="true"></i>Atendimento priorit&aacute;rio</li>
                </ul>
